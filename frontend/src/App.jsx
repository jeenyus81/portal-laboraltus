...
function App() {
  ...
  async function loadAllHrActivities(token) {
    if (!token) {
      setAllActivities([])
      return
    }
  ...
  useEffect(() => {
    if (!loggedIn || user?.role !== 'HR' || companyView !== 'activityHistory') {
      return
    }
    ...
    <div className="hr-dashboard-bottom">
      ...
      <section className="hr-dashboard-box">
        ...
        <button
          ...
          onClick={() => {
            setActiveMenu('dashboard')
            setCompanyView('activityHistory')
          }}
        >
          Ver todo
        </button>
        ...
        <div className="hr-quick-actions">
          ...
          >
            ...
            <div className="hr-quick-action-content">
              ...
              <span>
                Seleccionar un empleado para añadir un contrato
              </span>
          ...
          >
            ...
            <div className="hr-quick-action-content">
              ...
              <span>
                Seleccionar un empleado para añadir una nómina
              </span>
...
{/* ================================================= */}
{/* HISTORIAL COMPLETO DE ACTIVIDAD RR. HH. */}
{/* ================================================= */}

{companyView === 'activityHistory' && (
  <div className="hr-dashboard">
    <div className="section-header">
      <div>
